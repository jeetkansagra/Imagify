  ...
  return (
    <div className='fixed top-0 left-0 right-0 bottom-0 z-10 backdrop-blur-sm bg-black/30 flex justify-center items-center'>
      ...
      className='relative bg-white p-10 rounded-xl text-slate-500' >
        ...
        { state !== 'Login' && <div className='border pc-6 py-2 flex items-center gap-2 rounded-full mt-5'>
            <img className='ml-1' width={24} src={assets.profile_icon} alt="" />
        ...
        <div className='border pc-6 py-2 flex items-center gap-2 rounded-full mt-4'>
            <img className='ml-2'  src={assets.email_icon} alt="" />
